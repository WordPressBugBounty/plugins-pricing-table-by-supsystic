...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.]( https://patchstack.com/database/vdp/9e5fb554-f2d8-4df3-9dc0-bbac3d7a0229 )
...
= 1.11.0 — August 7, 2026 =

* Fixed a PHP warning in the Toggle Switch column editor when reopening a table that already has saved toggle options.
...
* Reworked core plugin internals and delivered ongoing compatibility updates for WordPress 6.8.x and 6.9.x.
* Fixed a text-domain loading issue and polished the admin interface.
* Versions released: 1.9.14–1.10.02.

= 2024 =

* Strengthened label handling for better security.
* Versions released: 1.9.13.

= 2023 =

* Added support for WordPress 6.2/6.3 and PHP 8.2.
* Refined the Love Link feature.
* Versions released: 1.9.10–1.9.12.

= 2022 =

* Added support for WordPress 6.0 and PHP 8.1.
* Versions released: 1.9.8–1.9.9.

= 2021 =

* Completed a major security and database hardening pass, and removed the bundled Bootstrap dependency.
* Migrated static assets from CDN to local files for GDPR compliance.
* Fixed the toggle switch, color picker, and OVH hosting connectivity issues.
* Versions released: 1.8.9–1.9.7.

= 2020 =

* Added WordPress 5.4/5.5 compatibility.
* Improved security and fixed a corrupted-table recovery issue.
* Versions released: 1.8.0–1.8.8.

= 2016-2019 =

* Added the Toggle Switch feature, a redesigned color picker, and Right-to-Left language support.
* Refined responsive behavior, tooltips, and column/template handling across numerous releases.
* Removed legacy CDN dependencies and improved translation support.

= 2015 and earlier =

* Established the plugin's core feature set: drag-and-drop table builder, PRO templates, CSS editor, import/export, and responsive tables.
