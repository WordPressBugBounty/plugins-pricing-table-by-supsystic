...
class templatesPts extends modulePts
{
  ...
  {
    $this->_styles = dispatcherPts::applyFilters('coreCssList', [
      'stylePts' => [
  ...
  public function loadGoogleFont($font)
  {
    ...
    if (!isset($loaded[$font])) {
      framePts::_()->addStyle('google.font.' . str_replace([' '], '-', $font), 'https://fonts.googleapis.com/css?family=' . urlencode($font));
      $loaded[$font] = 1;
    }
  }
}
