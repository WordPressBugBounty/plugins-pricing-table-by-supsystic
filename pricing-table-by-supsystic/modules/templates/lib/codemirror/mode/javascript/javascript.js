(function (e) {
  ...
  e.defineMode('javascript', function (t, n) {
    ...
    var f = (function () {
      ...
      if (u) {
        ...
        var f = { interface: e('interface'), extends: e('extends'), constructor: e('constructor'), public: e('public'), private: e('private'), protected: e('protected'), static: e('static'), string: a, number: a, bool: a, any: a };
        for (var l in f) {
          o[l] = f[l];
        }
      }
    ...
    var p, d;
    var w = '([{}])';
    var S = { atom: true, number: true, variable: true, string: true, regexp: true, this: true, 'jsonld-keyword': true };
    var C = { state: null, column: null, marked: null, cc: null };
    var O = { name: 'this', next: { name: 'arguments' } };
    P.lex = true;
    return {
      startState: function (e) {
        var t = { tokenize: m, lastType: 'sof', cc: [], lexical: new x((e || 0) - r, 0, 'block', false), localVars: n.localVars, context: n.localVars && { vars: n.localVars }, indented: 0 };
  ...
  e.defineMIME('application/typescript', { name: 'javascript', typescript: true });
});
