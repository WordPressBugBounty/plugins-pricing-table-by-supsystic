(function (e) {
  ...
  e.defineMode(
    ...
    function (t, n) {
      ...
      var r = e.getMode(t, { name: 'xml', htmlMode: true, multilineTagIndentFactor: n.multilineTagIndentFactor, multilineTagIndentPastTag: n.multilineTagIndentPastTag });
      var i = e.getMode(t, 'css');
      var s = [],
        o = n && n.scriptTypes;
      s.push({ matches: /^(?:text|application)\/(?:x-)?(?:java|ecma)script$|^$/i, mode: e.getMode(t, 'javascript') });
      if (o)
      ...
      return {
        ...
        copyState: function (t) {
          ...
          return { token: t.token, localMode: t.localMode, localState: n, htmlState: e.copyState(r, t.htmlState) };
        },
        token: function (e, t) {
          return t.token(e, t);
        },
