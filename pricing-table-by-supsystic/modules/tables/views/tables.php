...
class tablesViewPts extends viewPts
{
  ...
  public function getImportExportTab()
  {
    ...
    framePts::_()->addJSVar('admin.tables.list', 'ptsTblDataUrl', uriPts::mod('tables', 'getListForTbl', ['reqType' => 'ajax', 'pts_nonce' => wp_create_nonce('pts_nonce')]));
  ...
  public function getTabContent()
  {
    ...
    framePts::_()->addJSVar(
      'admin.tables.list',
      'ptsTblDataUrl',
      uriPts::mod('tables', 'getListForTbl', [
        'reqType' => 'ajax',
        'pts_nonce' => wp_create_nonce('pts_nonce'),
      ]),
    );
  ...
  public function getAddNewTabContent()
  {
    ...
    if ($changeFor) {
      ...
      dispatcherPts::addFilter('mainBreadcrumbs', [$this, 'modifyBreadcrumbsForChangeTpl']);
    }
  ...
  public function getEditTabContent($id)
  {
    ...
    dispatcherPts::addAction('afterAdminBreadcrumbs', [$this, 'showEditTableFormControls']);
    dispatcherPts::addFilter('mainBreadcrumbs', [$this, 'changeMainBreadCrumbsClb']);
  ...
  public function renderTable($table, $isEditMode = false)
  {
    ...
    if (!empty($table['params']['option_name_input']['val'])) {
      ...
      if (!empty($toggleOptions)) {
        ...
        if (!empty($toggleOptions) && !isset($toggleOptions[0]['key'])) {
          ...
          $newParams['option_name_input']['val'] = base64_encode(
            json_encode([
    ...
    $this->_initTwig();
    return $this->_twig->render($content, [
      'table' => $table,
  ...
  public function renderForPost($pid, $params = [])
  {
  ...
  public function renderBlock($block = [], $isEditMode = false)
  {
  ...
  public function connectFrontendAssets($tables = [], $isEditMode = false)
  {
    $isDebbug = true;
    $isPro = framePts::_()->getModule('supsystic_promo')->isPro();
    ...
    framePts::_()->addScript('frontend.pts.base', $this->getModule()->getModPath() . 'js/frontend.pts.base.js', ['jquery'], false, true);
    if ($isPro && framePts::_()->getModule('tablepro') && is_admin()) {
      framePts::_()->addScript('admin.tablesPro', framePts::_()->getModule('tablepro')->getModPath() . 'js/admin.pro.tables.js', ['jquery'], false, true);
    } elseif ($isPro && framePts::_()->getModule('tablepro')) {
      framePts::_()->addScript('frontend.tablesPro', framePts::_()->getModule('tablepro')->getModPath() . 'js/frontend.pro.tables.js', ['jquery'], false, true);
    }
    framePts::_()->addJSVar('frontend.pts.base', 'ptsBuildConst', [
      'standardFonts' => utilsPts::getStandardFontsList(),
    ]);
  }
  public function connectEditorAssets($tables = [])
  {
  ...
  public function connectEditorJs($tables = [])
  {
    ...
    $ptsEditor['posts'] = [];
    global $wpdb;
    $postTypesForPostsList = ['page', 'post', 'product', 'blog'];
  ...
  public function connectEditorCss($tables = [])
  {
  ...
  protected function _initTwig()
  {
    if (!$this->_twig) {
      ...
      $this->_twig->addFunction(new Twig_SimpleFunction('adjBs', [$this, 'adjustBrightness']));
    }
  }
