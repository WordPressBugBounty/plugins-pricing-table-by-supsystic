...
class supsystic_promoControllerPts extends controllerPts
{
  ...
  public function getPermissions()
  {
    return [
      PTS_USERLEVELS => [
        PTS_ADMIN => ['welcomePageSaveInfo', 'sendContact', 'compileTyniMce', 'dropTinyMceFullPlugins', 'addNoticeAction', 'sendSubscribeMail', 'sendSubscribeRemind', 'sendSubscribeDisable'],
      ],
    ];
  }
}
