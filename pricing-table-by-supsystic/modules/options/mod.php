...
class optionsPts extends modulePts
{
  private $_tabs = [];
  private $_options = [];
  private $_optionsToCategoires = [];
  public function init()
  {
    dispatcherPts::addAction('afterModulesInit', [$this, 'initAllOptValues']);
  ...
  {
    if (empty($this->_tabs)) {
      $this->_tabs = dispatcherPts::applyFilters('mainAdminTabs', []);
  ...
  public function getAll()
  {
    if (empty($this->_options)) {
      ...
      $this->_options = dispatcherPts::applyFilters('optionsDefine', [
        'general' => [
