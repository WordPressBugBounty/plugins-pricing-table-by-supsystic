...
?>
        ...
        continue;
            ...
            <div class="supsystic-container supsystic-<?php echo $this->activeTab; ?>">
				<?php
//dispatcherPts::doAction('discountMsg');
?>
...
<div id="ptsOptInProWnd" style="display: none;" title="<?php _e('Improve Free version', PTS_LANG_CODE); ?>">
	<p>
		<?php printf(
    __('Please be advised that this option is available only in <a target="_blank" href="%s">PRO version</a>. You can <a target="_blank" href="%s" class="button">Get PRO</a> today and get this and other PRO option for your Pricing Tables!', PTS_LANG_CODE),
    $this->mainLink,
    $this->mainLink,
  ); ?>
	</p>
