...
class htmlPts
{
  ...
  public static function ajaxfile(
    $name,
    $params = [
      'url' => '',
      'value' => '',
  ...
  public static function nonajaxautocompleate(
    $name,
    $params = [
      'attrs' => '',
      'options' => [],
  ...
  public static function statesInput(
    $name,
    $params = [
      'value' => '',
      'attrs' => '',
  ...
  public static function statesListMultiple(
    $name,
    $params = [
      'value' => '',
      'attrs' => '',
  ...
  public static function countryListMultiple(
    $name,
    $params = [
      'value' => '',
      'attrs' => '',
  ...
  public static function textFieldsDynamicTable(
    $name,
    $params = [
      'value' => '',
      'attrs' => '',
  ...
  public static function productsSelectlist(
    $name,
    $params = [
      'attrs' => '',
      'size' => 5,
  ...
  public static function productsSelectbox(
    $name,
    $params = [
      'attrs' => '',
      'size' => 5,
  ...
  public static function textIncDec(
    $name,
    $params = [
      'value' => '',
      'attrs' => '',
  ...
  public static function slideInput(
    $name,
    $params = [
      'attrs' => '',
      'checked' => false,
    ...
    return '<a class="toeSlideShellPts" href="#"' .
      $params['attrs'] .
      '>
			<span class="toeSlideButtPts"></span>
			<span class="toeSlideOnPts">' .
      __('ON') .
      '</span>
			<span class="toeSlideOffPts">' .
      __('OFF') .
      '</span>
