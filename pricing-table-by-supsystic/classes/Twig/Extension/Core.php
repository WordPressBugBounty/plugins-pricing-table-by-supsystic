...
class Twig_Extension_Core extends Twig_Extension
{
  ...
  public function getTests()
  {
    return [
      ...
      new Twig_SimpleTest('sameas', null, ['node_class' => 'Twig_Node_Expression_Test_Sameas', 'deprecated' => true, 'alternative' => 'same as']),
      ...
      new Twig_SimpleTest('divisibleby', null, ['node_class' => 'Twig_Node_Expression_Test_Divisibleby', 'deprecated' => true, 'alternative' => 'divisible by']),
  ...
  public function parseTestExpression(Twig_Parser $parser, Twig_NodeInterface $node)
  {
    ...
    [$name, $test] = $this->getTest($parser, $node->getLine());
